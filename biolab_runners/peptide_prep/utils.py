...
# Canonical 1-letter → 3-letter amino-acid table. SINGLE source of
# truth for the peptide-prep package: the runner (chirality reports)
# and the mutation layer (PDBFixer mutation strings) both import
# this. Mirrors ``_CANONICAL_AA_ALPHABET`` in
# :mod:`biolab_runners.peptide_prep.config` (20 amino acids; X / U /
# O are rejected by the config validator).

...
# Canonical 1-letter → 3-letter table. Mirrors
# :data:`biolab_runners.peptide_prep.config._CANONICAL_AA_ALPHABET`
# (20 amino acids; X / U / O rejected by the config validator).
...
def build_mutation_list(
    ...
    for index, (one_letter, source_name) in enumerate(
        ...
        target_name = _THREE_LETTER.get(one_letter_upper)
